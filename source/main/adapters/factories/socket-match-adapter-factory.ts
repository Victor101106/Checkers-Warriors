...
import { movePieceSocketHelper } from "../helpers/factories/move-piece-socket-helper-factory"
import { SocketMatchAdapter } from "../socket-match-adapter"
import socket from "../../configs/socket"

export const socketMatchAdapter = new SocketMatchAdapter(findAllMovementsSocketHelper, receiveMatchSocketHelper, movePieceSocketHelper, joinMatchSocketHelper, socket)