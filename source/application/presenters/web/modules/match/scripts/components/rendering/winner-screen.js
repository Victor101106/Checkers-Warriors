export class WinnerScreen {
    ...
    render(deltatime) {
        ...
        const image = this.parent.sprites[(this.parent.state.indexOf == -1 || this.parent.state.winner == this.parent.state.indexOf ? 'won-text-' : 'loss-text-') + (this.parent.state.winner == 0 && (this.parent.state.indexOf == -1 || this.parent.state.winner == this.parent.state.indexOf) ? "white" : "black") ]
