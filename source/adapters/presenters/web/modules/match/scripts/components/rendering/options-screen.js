export class OptionsScreen {
    ...
    configureElements() {
        ...
        const enableAnimationsToggleCaption = "Enable Animations"
        ...
        const enableRotationToggleCaption = "Enable Rotation"
        ...
        const enableEffectsToggleCaption = "Enable Effects"
        ...
        const enableSoundsToggleCaption = "Enable Sounds"
        ...
        const exitToHomeButtonCaption = "Exit to Home"
        ...
        const exitToHomeButtonTop = translateY + 5 + 4 * 7
        const exitToHomeButtonHeigth = 5 
        
        const giveUpButtonCaption = "Give Up"
        ...
        const giveUpButtonTop = translateY + 5 + 5 * 7
        const giveUpButtonHeigth = 5 
        
        const closeButtonCaption = "Close"
        ...
        const closeButtonTop = translateY + 5 + 6 * 7
    ...
    render(deltatime) {
        ...
        this.context.drawImage(this.parent.images.sectionSeparator, enableAnimationsToggle.left + enableAnimationsToggle.width / 2 - 17 / 2 | 0, enableSoundsToggle.top + enableSoundsToggle.height + 2 | 0)
